...
M.setup = function()
  ...
  which_key.setup(xvim.builtin.which_key.setup)

  local opts = xvim.builtin.which_key.opts
  local vopts = xvim.builtin.which_key.vopts

  local mappings = xvim.builtin.which_key.mappings
  local vmappings = xvim.builtin.which_key.vmappings
