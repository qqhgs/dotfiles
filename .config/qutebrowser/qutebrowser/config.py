...
# Change editor
# c.editor.command = ["kitty", "-e", "nvim", "{file}", "+call cursor({line}, {column})"]
...
c.colors.tabs.selected.odd.bg = '#34426f'

# Background color of selected even tabs.
# Type: QtColor
# c.colors.tabs.selected.even.bg = '#282c34'
c.colors.tabs.selected.even.bg = '#34426f'
...
config.bind('Zm', 'hint links spawn kitty -e youtube-dl -x --audio-format mp3 --prefer-ffmpeg -o "%(title)s.%(ext)s" {hint-url}')
config.bind('Zv', 'hint links spawn kitty -e youtube-dl -f "best[height<=360]" -o "~/Videos/%(title)s - %(creator)s.%(ext)s" "{hint-url}"')
